...
#ifdef CK_LIB
	#define RegisterBehaviorDeclarations	Register_BBAddons2_BehaviorDeclarations
	#define InitInstance					_BBAddons2_InitInstance
	#define ExitInstance					_BBAddons2_ExitInstance
	#define CKGetPluginInfoCount			CKGet_BBAddons2_PluginInfoCount
	#define CKGetPluginInfo					CKGet_BBAddons2_PluginInfo
	#define g_PluginInfo					g_BBAddons2_PluginInfo
#else
