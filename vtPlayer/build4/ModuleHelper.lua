	...
	configuration(cfg.name)
		...
		if table.contains(packageConfig.Defines,"VIRTOOLS_USER_SDK") then
			...
			if _OPTIONS["Static"] =="TRUE" then
				cfgDefine  = table.join( cfgDefine, {  "VX_LIB" ; "CK_LIB" ; "VNK_LI" ; "VSU_LIB" ; "VSM_LIB" ; "VSS_LIB" ; "CUSTOM_PLAYER_STATIC";   } )
		...
		if packageConfig.StaticModules then
			emodules = { 	}
			emodules = table.join(packageConfig.StaticModules)
			cfgDefine  = table.join( cfgDefine, emodules )
		end
