...
std::string to_string(PyObject* val);
  ...
  typedef std::multimap<std::string, Type> Arg_map;
  typedef std::map<std::string, std::string> String_map;
  typedef std::vector<std::string> String_list;
  
  typedef std::multimap<std::string, Type> Arg_mmap;
  ...
  public:
     ...
     * @param module_name
     */
    void load(const std::string& module_name,bool reload)
      throw (Python_exception);
	...
	* @param func_name
	*/
	void call(PyObject*imodule,const std::string& func_name)
		throw (Python_exception);
	...
	*/
     ...
     * here.
     */
    void call(const std::string& func_name,const Arg_map& args,std::string& ret)
      throw (Python_exception);
	...
	* here.
	*/
	void call(PyObject *imodule,const std::string& func_name,const Arg_map& args,std::string& ret)
		throw (Python_exception);
	...
	* @return PyObject*
	*/
	PyObject* get_function_object(PyObject *imodule,const std::string& func_name)
		throw (Python_exception);
	...
	PyObject* create_args(const Arg_mmap& args,PyObject* val)
		throw (Python_exception);
	...
	* or null if no value is returned.
	*/
	PyObject* make_call(PyObject *imodule,const std::string& func_name,
		const Arg_map& args)
		throw (Python_exception);
  ...
  public:
	...
	PyObject* Module() const { return module; }
	void Module(PyObject* val) { module = val; }
	...
	public:
		...
		PyObject*GetModule(){ return module;}
