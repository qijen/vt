...
packageConfig_vtAgeiaLib =
{
	...
	Defines 	= { DEF_STD_DIRECTIVES 	; 	DEF_PHYSX_DIRECTIVES ; "NX_USE_SDK_STATICLIBS" ; "NXCHARACTER_EXPORTS" ; "VIRTOOLS_USER_SDK" ; "MODULE_STATIC" ; "VX_LIB" ; "CK_LIB" },
	Files		= { DROOT.."SDK/src/core/**.cpp"	;	DROOT.."SDK/include/core/**.h"  ; F_BASE_STD_INC ;F_VT_STD_INC; F_BASE_VT_SRC ;F_BASE_SRC;F_SHARED_SRC ; DROOT.."SDK/src/Behaviors/**.cpp"	; DROOT.."SDK/src/Behaviors/*.def" ; F_EXTRA_BB_SRC },
	Includes  	= { D_PHYSX_INCLUDES ; D_STD_INCLUDES ; D_VT_BASE_INC; D_CORE_INCLUDES ; DDEPS.."TinyXML" ; D_DX.."include"  },
	Libs	= {	"TinyXML" , "NxCharacter" , "NxCommon" , "NxuStream2"; "user32" ;  "kernel32" ; "PhysXLoader" ; "Winmm" ; "dxerr"; "dinput8";"dxguid" },
...
packageConfig_vtAgeiaBeh =
{
	...
	Libs	= {	"ck2" ; "vxmath"  ; "user32" ;  "kernel32" ; "vtPhysXLib" ;"Winmm" ; "dxerr"; "dinput8";"dxguid" ; D_DX.."include" },
	LibDirectories = { D_PHYSX.."SDKs/lib/Win32" ; D_DX.."lib" },
	Options = { "/W0"},
