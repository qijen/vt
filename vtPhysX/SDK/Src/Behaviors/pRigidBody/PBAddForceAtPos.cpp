...
CKERROR CreateAddForceAtPosProto(CKBehaviorPrototype **pproto)
{
	...
	point in global coordinates, to the actor. <br>
	...
	<BR>
	<SPAN CLASS="pin">Point:</SPAN>Position in the global/local frame to add the force at.
	<BR>
	<SPAN CLASS="pin">Point Reference:</SPAN>Reference object to transform a local point into world coords.
	<BR>
	...
	<br>
	<br>
	Is utilizing #pRigidBody #pWorld #PhysicManager #pRigidBody::addForceAtPos().<br>
	*/
...
int AddForceAtPos(const CKBehaviorContext& behcontext)
{
	...
	if( beh->IsInputActive(0) )
	{
		...
		VxVector vec0  = GetInputParameterValue<VxVector>(beh,1);
		...
		int fMode = GetInputParameterValue<int>(beh,3);
		//////////////////////////////////////////////////////////////////////////
		// the world :  
