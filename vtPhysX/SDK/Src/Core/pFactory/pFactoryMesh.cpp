...
void pFactory::createConvexMesh(NxScene *scene,CKMesh *mesh,NxConvexMeshDesc&descr,bool hardware)
{
...
void
pFactory::createMesh(NxScene *scene,CKMesh *mesh,NxTriangleMeshDesc&descr,bool hardware)
{
