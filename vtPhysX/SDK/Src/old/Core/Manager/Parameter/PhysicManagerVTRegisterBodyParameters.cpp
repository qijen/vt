...
void PhysicManager::_RegisterBodyParameters()
{
	...
	pm->RegisterNewFlags(VTF_TRIGGER,"pTriggerFlags","Disable=0,OnEnter=1,OnLeave=2,OnStay=4");
	...
	pm->RegisterNewFlags(VTF_BODY_FLAGS,"pBFlags","Moving Object=1,World Gravity=2,Collision=4,Kinematic Object=8,Sub Shape=16,Hierarchy=32,Add Attributes=64,Trigger Shape=128,Deformable=256,Collision Notify=512,Sleep=1024");
